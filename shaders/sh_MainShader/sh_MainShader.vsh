...
void main() {
	...
	float lightAngleDiff = max(dot(worldNormal, lightDirection), 0.0);
	
    v_vColour = in_Colour * vec4(min(lightAmbient + lightColor * lightAngleDiff, vec4(1.0)).xyz, in_Colour.a);
